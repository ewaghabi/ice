...
// Tabelas de posição pré-computadas (brancas)
static const int tabPeao[64] = {    0,    0,    0,    0,    0,    0,    0,    0,
...
static const int tabCavalo[64] = {  0,    2,    6,    7,    7,    6,    2,    0,
...
static const int tabBispo[64] =  {  5,    3,    3,    3,     3,   3,    3,    5,
                                    3,   10,    9,    9,     9,   9,   10,    3,
                                    3,    9,   15,   14,    14,  15,    9,    3,
                                    3,    9,   14,   20,    20,  14,    9,    3,
                                    3,    9,   14,   20,    20,  14,    9,    3,
...
static const int tabTorre[64] =  { 25,   25,   25,   25,    25,  25,   25,   25,
...
static const int tabRei[64] =    { -5,   -3,   -3,   -3,    -3,  -3,   -3,   -5,
                                   -3,  -10,   -9,   -9,    -9,  -9,  -10,   -3,
                                   -5,   -9,  -15,  -14,   -14, -15,   -9,   -5,
                                   -1,   -5,  -14,  -20,   -20, -14,   -5,   -1,
                                    2,   -1,   -5,  -20,   -20,  -5,   -1,    2,
...
static const int tabReiFinal[64]={  5,    3,    3,    3,     3,   3,    3,    5,
                                    3,    9,    9,    9,     9,   9,    9,    3,
                                    3,    9,   15,   14,    14,  15,    9,    3,
                                    3,    9,   14,   20,    20,  14,    9,    3,
                                    3,    9,   14,   20,    20,  14,    9,    3,
...
int ValorPosicao(TByte tipoPeca, int casa, int bando, int numLance) {
  int idx = bando ? (63 - casa) : casa;
  switch (tipoPeca) {
    case PEAO:   return tabPeao[idx];
    case CAVALO: return tabCavalo[idx];
    case BISPO:  return tabBispo[idx];
    case TORRE:  return tabTorre[idx];
    case DAMA:   return tabBispo[idx] + tabTorre[idx];
    default:     return (numLance < 35) ? tabRei[idx] : tabReiFinal[idx];
  }
}
